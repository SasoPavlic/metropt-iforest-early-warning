...
from experiments.iforest_data import (
...
from experiments.iforest_metrics import confusion_and_scores, window_mask
from experiments.iforest_model import train_iforest_and_score
from experiments.iforest_plotting import prepare_plot_frame, plot_raw_timeline
...
def main() -> None:
    ...
    pred["operation_phase"] = operation_phase.values
    raw_reindexed = raw_reindexed.join(operation_phase, how="left")
